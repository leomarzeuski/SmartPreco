...
export const getReadProductsMockHandler = (overrideResponse?: ProductsDto | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ProductsDto> | ProductsDto)) => {
...
export const getReadProductMockHandler = (overrideResponse?: ProductDto | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ProductDto> | ProductDto)) => {
  return http.get('*/products/:productId', async (info) => {await delay(1000);
...
export const getUpdateProductMockHandler = (overrideResponse?: ProductDto | ((info: Parameters<Parameters<typeof http.patch>[1]>[0]) => Promise<ProductDto> | ProductDto)) => {
  return http.patch('*/products/:productId', async (info) => {await delay(1000);
...
export const getDeleteProductMockHandler = (overrideResponse?: void | ((info: Parameters<Parameters<typeof http.delete>[1]>[0]) => Promise<void> | void)) => {
  return http.delete('*/products/:productId', async (info) => {await delay(1000);
